...
@section('content')
    ...
    <section class="section-qa bg-[#fcfcfc] py-6 2xl:py-10">
        <div class="container 2xl:!max-w-[1250px]">
            ...
            <div class="grid grid-cols-1 lg:flex gap-4 lg:grid-cols-4 2xl:gap-8">
                <div class="col-span-1 lg:w-[245px]">
                    @include('question_categories.sidebar')
                </div>
                <h1 class="hidden">{{ Support::show($currentItem, 'name') }}</h1>
                <div class="col-span-1 lg:col-span-2 lg:flex-1">
                    <div class="box-content border-[1px] border-solid border-[#ebebeb] bg-white py-4 lg:py-8 2xl:pt-12">
                        <p class="title-qa text-center text-[1.3rem] font-bold text-[#767676] lg:text-[1.5rem] 2xl:text-[2rem]">Hỏi đáp chuyên gia</p>
