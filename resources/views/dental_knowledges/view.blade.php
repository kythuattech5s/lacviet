...
<div class="main-breadcrumb 2xl:my-9 lg:my-6 my-4 py-3 border-t-[1px] border-b-[1px] border-solid border-[#3286be]">
    <div class="container">
        {{\Breadcrumbs::render('dental_knowledge',$currentItem,$parent)}}
    </div>
</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 2xl:gap-8 gap-4">
            <div class="col-span-1 lg:col-span-3">
                    ...
                    <div class="content sm:p-4 p-2 flex 2xl:gap-8 lg:gap-6 sm:gap-4 gap-2">
                        ...
                        <div class="info-expert">
                            ...
                            <div class="flex items-center flex-wrap sm:gap-4 gap-2">
                                ...
                                <a href="tel: {[hotline]}" title="Đăng ký khám" class="btn-border__blue inline-flex items-center justify-center lg:text-[0.875rem] py-3 px-4 text-[#333] bg-transparent transition-all duration-300 border-[1px] border-solid border-[#028cde]">
                                        Tổng đài <strong class="font-bold">{[hotline]}</strong>
                                    </a>
                                <a href="{{Support::show($doctor,'slug')}}" title="Xem thêm thông tin bác sĩ" class="btn-border__yellow inline-flex items-center justify-center lg:text-[0.875rem] py-3 px-4 text-[#333] bg-transparent transition-all duration-300 border-[1px] border-solid border-[#eea517] hover:bg-[#eea517] hover:text-white">
                ...
                <div class="box-endow p-4 2xl:my-20 lg:my-8 my-6 bg-[#f6f7f8] border-[1px] border-dashed border-[#f45654]">
                    ...
                    <div class="flex items-center justify-center sm:gap-4 gap-2 flex-wrap">
                        <a href="{{VRoute::get('orderExaminationSchedule')}}?service={{$saleSevice->id}}" title="Đăng ký ngay" class=" btn-red w-[200px] lg:min-w-[268px] inline-flex items-center justify-center lg:text-[0.875rem] uppercase py-3 px-4 rounded-2xl text-white bg-[#f43d3b] transition-all duration-300">
                            Đăng ký ngay
                        </a>
                        <a href="tel:{[hotline]}" title="Đăng ký ngay" class="btn-yellow w-[200px] lg:min-w-[268px] inline-flex items-center justify-center lg:text-[0.875rem] uppercase py-3 px-4 rounded-2xl text-white bg-[#ed9f09] transition-all duration-300">
                            {[hotline]}
                        </a>
                    </div>
                </div>
