    ...
    <div class="container">
        <div class="grid grid-cols-1 lg:grid-cols-4 2xl:gap-8 gap-4">
            <div class="col-span-1 lg:col-span-3">
                <h1 class="title-all mb-6 text-[1.25rem] font-semibold uppercase text-[#0557ac] lg:text-[1.5rem] 2xl:mb-10 2xl:text-[2rem]">{{Support::show($currentItem,'name')}}</h1>
                <div class="image-about mb-4">
                    @include('image_loader.all',['itemImage'=>$currentItem,'key'=>'img'])
                </div>
                <ul class="text-[#737373] font-semibold mb-6 flex items-center lg:gap-8 gap-3 flex-wrap sm:justify-start justify-between">
                    <li class="inline-block">
                        <img src="theme/frontend/images/cal.png" class="inline-block lg:w-6 lg:h-6 w-4 h-4 object-contain mr-2" alt="icon">
                        {{Support::show($currentItem,'created_at')}}
                    </li>
                    <li class="inline-block">
                        <img src="theme/frontend/images/user.png" class="inline-block lg:w-6 lg:h-6 w-4 h-54object-contain mr-2" alt="icon">
                        Tác giả: {{Support::show($currentItem,'publish_by')}}
                    </li>
                    <li class="inline-flex items-center">
                        <i class="fa fa-eye lg:text-[1.5rem] text-[1.125rem] mr-2" aria-hidden="true"></i>
