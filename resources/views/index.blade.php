...
<head>
    ...
    <link href="theme/frontend/css/app.css?v={{time()}}" type="text/css" rel="stylesheet" />

    <link rel="stylesheet" href="{{ asset('./css/app.css?v=5.2') }}">
    ...
    <link href="theme/frontend/css/main.css?v={{time()}}" type="text/css" rel="stylesheet" />
