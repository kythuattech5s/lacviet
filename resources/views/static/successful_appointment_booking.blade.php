...
<section class="2xl:py-10 py-6">
    <div class="container">
        <div class="thankyou max-w-[900px] rounded-3xl mx-auto bg-[rgba(64,181,255,.16)] text-center 2xl:py-12 2xl:px-20 lg:py-6 lg:px-12 p-4">
            <p class="title title-all font-bold 2xl:text-[2rem] lg:text-[1.5rem] text-[1rem] text-[#014bb6] uppercase 2xl:mb-6 mb-4">
                thank you!</p>
            <p class="text-medium 2xl:text-[1.25rem] text-[0.875rem] uppercase text-[#0b5cc2] mb-4">CẢM ƠN QUÝ KHÁCH ĐÃ ĐẶT LỊCH HẸN KHÁM BỆNH</p>
            <p class="text text-[#040404] mb-4">Chúng tôi sẽ liên hệ lại với Quý khách trong thời gian sớm nhất!</p>
