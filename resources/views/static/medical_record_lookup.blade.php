            ...
            <div class="col-span-1 lg:col-span-3 lg:flex-1">
                <div class="box-content bg-white border-[1px] border-solid border-[#ebebeb] lg:rounded-2xl overflow-hidden">
                    ...
                    <div class="content 2xl:p-14 lg:p-8 p-4">
                        <form action="{{\VRoute::get("medicalRecordLookup")}}" method="post" class="form_tracuubenhan form-search-doc flex justify-between sm:justify-start sm:gap-4 gap-2 items-center 2xl:mb-8 mb-6">
                            @csrf
                            <div class="wrapper-form flex gap-3 max-w-[60%] sm:max-w-full items-center flex-1 lg:h-9 h-7 border-[1px] border-solid border-[#ebebeb] rounded-sm lg:rounded-lg px-4 lg:py-2 py-1">
                                ...
                                <input type="text" name="patient_code" value="{{$patientCode ?? ''}}" placeholder="Mã bệnh nhân:" required class="form-control flex-1 lg:pl-8  text-[#373737] placeholder:text-[#373737]" value="{{$patientCode ?? ''}}">
                            </div>
                        ...
                        @if (isset($listLichKham))
                            ...
                            @else
                                <p class="text-center text-[20px]">Không tìm thấy thông tin bệnh án</p>
                            @endif
                        @endif
                    </div>
                </div>
