<div class="item-experts h-full border-[1px] border-solid border-[#7fc4ee] p-2 rounded-xl overflow-hidden text-center shadow-[0_0_8px_rgba(216,229,251,.8)]">
    ...
    <p class="text font-bold 2xl:text-[1.125em] 2xl:mb-4 mb-2">{{Support::show($item,'academic_rank')}}</p>
