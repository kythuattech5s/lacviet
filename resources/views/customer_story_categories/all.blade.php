...
<section class="section-new__category 2xl:py-10 py-6">
    <div class="container">
        <div class="module-new__hot mb-4 sm:mb-1">
            <div class="head-flex flex items-center justify-between mb-4">
                <h1 class="title-all uppercase 2xl:text-[2rem] lg:text-[1.5rem] text-[1.25rem] text-[#028cde] font-semibold !mb-0">{{$currentItem->vi_name}}</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 2xl:gap-8 sm:gap-4 gap-2">
                @php
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:flex">
            <div class="col-span-1 lg:col-span-3 lg:flex-1">
                ...
                <div class="module-new__category 2xl:pt-14 lg:pt-10 lg:pb-7 lg:py-5 py-2 lg:border-b-[3px] border-solid border-[#028cde]">
                    <h2 class="title-all uppercase 2xl:text-[1.75rem] lg:text-[1.4rem] text-[1rem] text-[#028cde] font-semibold 2xl:mb-6 mb-4">
                        <a href="{{Support::show($itemCateChild,'slug')}}" title="{{Support::show($itemCateChild,'name')}}">{{Support::show($itemCateChild,'name')}}</a>
                    </h2>
