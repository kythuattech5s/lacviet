    ...
    <div class="container">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 2xl:gap-8 gap-4">
                ...
                <div class="col-span-1 lg:col-span-2">
                    <div class="item-new__main">
                        ...
                        <h3>
                            <a href="{{Support::show($itemNewsHotBig,'slug')}}" title="{{Support::show($itemNewsHotBig,'name')}}" class="title line-clamp-2 text-[#7b7b7b] font-bold 2xl:text-[1.25rem] text-[1rem] mb-2">{{Support::show($itemNewsHotBig,'name')}}</a>
                        </h3>
                ...
                <div class="col-span-1 new-small-list">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
                        ...
                        <div class="col-span-1">
                            <div class="item-new__main flex gap-2 sm:block">
                                <div class="relative shrink-0 sm:w-full w-[150px] image 2xl:mb-4 mb-2 pb-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
            <div class="col-span-1 lg:col-span-3">
                ...
                @php
                $listItemNews = $itemCateChild->customerStory()->act()->orderBy('time_published','desc')->limit(5)->get();
                ...
                <div class="module-new__category 2xl:pt-14 lg:pt-10 lg:pb-7 lg:py-5 py-2 lg:border-b-[3px] border-solid border-[#028cde]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="col-span-1">
                            ...
                            <a href="{{Support::show($itemCateChild,'slug')}}" title="Xem thêm" class="btn-readmore mt-4 flex w-fit ml-auto mr-auto lg:mr-0 items-center justify-center lg:text-[0.875rem] py-3 px-4 rounded-3xl bg-transparent transition-all duration-300 border-[1px] border-solid border-[#028cde] hover:bg-[#028cde] hover:text-white">
