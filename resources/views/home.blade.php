...
@section('content')
	...
	<section class="py-6 lg:py-14 2xl:py-20">
		<div class="container">
			<p class="title-all mb-6 text-center text-[1.25rem] font-semibold uppercase text-[#028cde] lg:mb-14 lg:text-[1.5rem] 2xl:mb-10 2xl:text-[2rem]">{[title_reson_choose_home]}</p>
				...
				@foreach ($listReasonChoose as $key => $itemReasonChoose)
					<div class="wow flipInY col-span-1 mb-4 sm:mb-0" data-wow-delay="{{ ($key + 1) * 0.1 }}s">
						<div class="item-reason rounded text-center">
							...
							<p class="title mb-2 text-center text-[1rem] font-bold uppercase text-[#000] lg:mb-4 lg:text-[1.125rem]">{{ Support::show($itemReasonChoose, 'name') }}</p>
				...
				<div class="grid grid-cols-1 gap-4 lg:grid-cols-5 lg:gap-8 2xl:gap-20">
					...
					<div class="wow fadeInRight col-span-1 lg:col-span-2">
						<p
							...
							{[title_frequent_question_home]}</p>
	...
	<section class="section-system py-6 2xl:py-14">
		<div class="container">
			...
			<p class="title-all mb-6 text-center text-[1.25rem] font-semibold uppercase text-[#028cde] lg:text-[1.5rem] 2xl:mb-10 2xl:text-[2rem]">{[title_base_system_home]}</p>
