		...
		<div class="grid grid-cols-2 gap-4 md:grid-cols-4 2xl:gap-6">
			...
			<div class="wow flipInY col-span-1" data-wow-delay="{{ ($key + 1) * 0.1 }}s">
				...
				<div class="item-reason rounded text-center">
					...
					<h3 class="title transition-all duration-300 hover:text-[#028cde] mb-2 text-center text-[0.875rem] sm:text-[1rem] font-bold uppercase text-[#000] lg:mb-4 lg:text-[1.125rem]">{{ Support::show($itemReasonChoose, 'name') }}</h3>
