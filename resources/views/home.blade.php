...
@section('content')
    ...
    <section class="py-6 2xl:py-10">
        <div class="container">
            <p class="title-all mb-6 text-center text-[1.25rem] font-semibold uppercase text-[#252525] lg:text-[1.5rem] 2xl:mb-10 2xl:text-[2rem]">{[title_reson_choose_home]}</p>
    ...
    <section class="section-system py-6 2xl:py-10">
        <div class="container">
            <p class="title-all mb-6 text-center text-[1.25rem] font-semibold uppercase text-[#252525] lg:text-[1.5rem] 2xl:mb-10 2xl:text-[2rem]">{[title_base_system_home]}</p>
            <div class="boxslide wow fadeInUp relative">
                ...
                <div class="button-circle button-circle__prev system_prev absolute top-1/2 z-[1] hidden h-8 w-8 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border-[1px] border-solid border-[#0557ac] text-[1.5rem] text-[#0557ac] transition-all duration-300 hover:bg-[#0557ac] hover:text-white lg:left-[-28px] lg:flex 2xl:-left-14 2xl:h-10 2xl:w-10">
                    <i class="fa fa-angle-left relative top-[-2px]" aria-hidden="true"></i>
                </div>
                <div class="button-circle button-circle__next system_next absolute top-1/2 z-[1] hidden h-8 w-8 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border-[1px] border-solid border-[#0557ac] text-[1.5rem] text-[#0557ac] transition-all duration-300 hover:bg-[#0557ac] hover:text-white lg:right-[-28px] lg:flex 2xl:-right-14 2xl:h-10 2xl:w-10">
    ...
    @if (count($listHomeNews) > 0)
        <section class="section-new__index bg-[#F5F5F5] py-6 2xl:py-10">
            <div class="container">
                <h2 class="title-all mb-6 text-center text-[1.25rem] font-semibold uppercase text-[#252525] lg:text-[1.5rem] 2xl:mb-10 2xl:text-[2rem]">{[title_new_home]}</h2>
                @php
                ...
                <div class="module-new__index grid grid-cols-1 gap-4 lg:grid-cols-2 2xl:gap-6">
                    @if (isset($bigItemNews))
                        <div class="wow fadeInLeft col-span-1">
                            <div class="item-new__main">
                                <a href="{{ Support::show($bigItemNews, 'slug') }}" title="{{ Support::show($bigItemNews, 'name') }}" class="img img__ c-img mb-2 block overflow-hidden rounded-2xl pt-[54%] 2xl:mb-4">
                            ...
                            @if ($key > 0)
                                <div class="list-new__item mb-4 flex gap-3 last:mb-0 2xl:mb-6">
                                    ...
                                    <div class="new-content">
                                        ...
                                        <a href="{{ Support::show($itemSmall, 'slug') }}" title="Xem thêm" class="text-[#008EDF] transition-all duration-300 lg:text-[0.875rem]">
                                            Xem thêm
                                            <i class="fa fa-angle-double-right ml-2" aria-hidden="true"></i>
                                        </a>
                                    </div>
