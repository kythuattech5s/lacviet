        ...
        <div class="col-span-1">
            <div class="new-sidebar flex items-center">
                ...
                <div class="new-content">
                    ...
                    <p class="count text-[0.625rem] text-[#262626] italic">Lượt xem: {{Support::show($itemNewNews,'count_view')}}</p>
                </div>
            </div>
        </div>
        @endforeach
...
<p class="head-title__sidebar text-center font-semibold uppercase py-2 px-3 text-white bg-[#028cde] 2xl:text-[1.25rem] text-[1rem]">
    Đăng ký tư vấn
</p>
