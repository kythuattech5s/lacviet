<div class="item-new__sidebar block sm:flex mb-4 last:mb-0">
    ...
    <div class="new-content">
        ...
        <div class="short_content lg:line-clamp-3 line-clamp-2 2xl:mb-4 mb-2">{{Support::show($item,'short_content')}}</div>
