    ...
    <div class="container">
        ...
        <div class="grid grid-cols-1 2xl:gap-8 gap-4 lg:flex">
            <div class="col-span-1 lg:col-span-3 lg:flex-1">
                ...
                <div class="mb-4 toc-wrapper hidden lg:block">
                    {!!$dataContent['toc']!!}
                </div>
                <div class="s-content mb-4 s-content-new">
                ...
                @endphp
                @if (isset($doctor))
                <div class="box-info-author 2xl:my-20 lg:my-8 md::my-6 my-2  shadow-[0_0_8px_rgba(216,229,251,.8)] bg-white">
                ...
                <div class="box-endow p-4 2xl:my-20 lg:my-8 my-6 bg-[#f6f7f8] border-[1px] border-dashed border-[#f45654] hidden">
                    ...
                    <p class="head-table-endow text-center uppercase text-white bg-[#028cde] 2xl:text-[1.125rem] text-[0.875rem] p-3">
                        Ưu đãi dịch vụ {{Support::show($saleSevice,'name')}}</p>
                    <div class="table-endow border-[1px] border-solid border-[#c5c5c5] 2xl:mb-6 mb-4">
                        <div class="tr-endow text-center sm:text-left grid grid-cols-2 border-b-[1px] border-solid border-[#c5c5c5] last:border-none">
                    ...
                    <div class="flex items-center justify-center sm:gap-4 gap-2 flex-wrap">
                        <a href="{{VRoute::get('orderExaminationSchedule')}}?service={{$saleSevice->id}}" title="Đăng ký ngay" class=" btn-red w-[200px] lg:min-w-[268px] inline-flex items-center justify-center lg:text-[0.875rem] uppercase lg:py-3 py-1 px-4 rounded-2xl text-white bg-[#f43d3b] transition-all duration-300">
                            Đăng ký ngay
                        </a>
                        <a href="tel:{[hotline]}" title="Đăng ký ngay" class="btn-yellow w-[200px] lg:min-w-[268px] inline-flex items-center justify-center lg:text-[0.875rem] uppercase lg:py-3 py-1 px-4 rounded-2xl text-white bg-[#ed9f09] transition-all duration-300">
                            {[hotline]}
                        </a>
                    </div>
                </div>
