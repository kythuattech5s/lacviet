            ...
            <div class="col-span-1 lg:col-span-3">
                    ...
                    <div class="content sm:p-4 p-2 flex 2xl:gap-8 lg:gap-6 sm:gap-4 gap-2">
                        ...
                        <div class="info-expert">
                            ...
                            <div class="flex items-center flex-wrap sm:gap-4 gap-2">
                                <a href="tel: {[hotline]}" title="Đăng ký khám" class="btn-border__blue inline-flex items-center justify-center lg:text-[0.875rem] lg:py-3 py-2 px-4 text-[#F63937] bg-transparent transition-all duration-300 border-[1px] border-solid border-[#F63937] rounded">
                ...
                <div class="box-endow p-4 2xl:my-20 lg:my-8 my-6 bg-[#f6f7f8] border-[1px] border-dashed border-[#f45654]">
                    ...
                    <div class="flex items-center justify-center sm:gap-4 gap-2 flex-wrap">
                        ...
                        <a href="tel:{[hotline]}" title="Đăng ký ngay" class="btn-yellow w-[200px] lg:min-w-[268px] inline-flex items-center justify-center lg:text-[0.875rem] uppercase lg:py-3 py-2 px-4 rounded-2xl text-[#008EDF] border-[1px] border-solid border-[#008EDF] hover:bg-[#008EDF] hover:text-white transition-all duration-300">
