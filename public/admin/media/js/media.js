...
MediaManager.applyChooseImage = function(){
    ...
    if(istiny==1){
      	...
      	for (var i = 0; i < arrFiles.length; i++) {
        	...
        	debugger;;
        	html +="<p style='text-align:center'><img title='"+objfile.title+"' alt='"+objfile.alt+"' class='img-responsive' src='"+objfile.path+objfile.file_name+"'/></p>"+ (objfile.caption==null || objfile.caption=="null"?"":"<p style='text-align:center'><span class='caption'>"+objfile.caption+"</span></p>") ;
      	}
