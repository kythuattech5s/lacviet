var TINYMCE = $(function() {
	...
	function init(){
		$('textarea.editor').tinymce({
			...
			'emoticons template paste textcolor colorpicker textpattern tech5sfilemanager fullscreen'
			],
			toolbar1:"code preview | bold italic underline hr strikethrough | alignleft aligncenter alignright alignjustify | blockquote | bullist numlist | removeformat subscript superscript",
			toolbar2:"styleselect formatselect fontselect fontsizeselect | link unlink table | forecolor backcolor | pastetext pagebreak | spellchecker | tech5sfilemanager | image media | fullscreen",
			toolbar3:"",
			style_formats: [
