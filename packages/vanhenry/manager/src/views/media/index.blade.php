			...
			<div class="media-bar">
				<div class="row mar-10">
					<div class="col-xs-6 col-xs-push-3  pad-10">
						...
						<form class="media-bar-s">
							<div style="display:flex;align-items: center;">
								<span style="white-space: nowrap;margin-right:3px">Tên:</span>
								<input type="text" name="keyword" value="{{$keyword ?? ''}}">
								<span style="white-space: nowrap;margin-left: 10px;margin-right:3px">Ngày tạo:</span>
					...
					<div class="col-xs-3 col-xs-pull-6 col-xs-6 pad-10">
						...
						<button type="button" data-toggle="modal" data-target="#folder-modal" data-toggle="tooltip" title="Thêm folder mới"><i class="fa fa-folder-open"></i><span class="hidden-md hidden-sm">New folder</span></button>
						@endif
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="media-view">
							@if($trash == 0)
							<a class="viewtrash" href="{{$admincp}}/media/trash">Thùng rác</a>
							@else
							<a class="viewtrash" href="{{$admincp}}/media/view">Thư mục gốc</a>
							@endif
							...
							<div class="btn-group" data-toggle="tooltip" title="Sắp xếp">
							  	...
							  	<ul class="dropdown-menu media-sort">
							    	<li><a data-sort="titleAsc" class="{{isset($ord) && $ord == 'titleAsc' ? 'active':''}}" href="#">Tên file <i class="fa fa-long-arrow-up"></i></a></li>
							    	<li><a data-sort="titleDesc" class="{{isset($ord) && $ord == 'titleDesc' ? 'active':''}}" href="#">Tên file <i class="fa fa-long-arrow-down"></i></a></li>
							    	<li><a data-sort="dateAsc" class="{{isset($ord) && $ord == 'dateAsc' ? 'active':''}}" href="#">Ngày tạo <i class="fa fa-long-arrow-up"></i></a></li>
							    	<li><a data-sort="dateDesc" class="{{isset($ord) && $ord == 'dateDesc' ? 'active':''}}" href="#">Ngày tạo <i class="fa fa-long-arrow-down"></i></a></li>
							    	<li><a data-sort="sizeAsc" class="{{isset($ord) && $ord == 'sizeAsc' ? 'active':''}}" href="#">Dung lượng <i class="fa fa-long-arrow-up"></i></a></li>
							    	<li><a data-sort="sizeDesc" class="{{isset($ord) && $ord == 'sizeDesc' ? 'active':''}}" href="#">Dung lượng <i class="fa fa-long-arrow-down"></i></a></li>
							  	</ul>
							</div>
