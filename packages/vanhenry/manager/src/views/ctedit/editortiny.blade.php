...
<script type="text/javascript">
	...
	$(function() {
		...
		$('.editortiny{{$name}}').tinymce({
	        ...
	        toolbar1:"code bold italic underline hr strikethrough | alignleft aligncenter alignright alignjustify | blockquote | bullist numlist outdent indent | fontsizeselect | link unlink anchor table | forecolor backcolor pastetext",
	        rel_list: [
