...
Route::group(['prefix' => $admincp, 'middleware' => 'web', 'namespace' => 'vanhenry\manager\controller'], function () {
    ...
    Route::get('general-slug',array('uses' => 'Admin@generalSlug'));
    Route::get('check-duplicate-field/{table}',array('uses' => 'Admin@checkFieldDuplicated'));
});

Route::group(['prefix' => 'gp', 'middleware' => 'web', 'namespace' => 'Tech5s\PageGrapes\Controllers'], function () {
    Route::get('edit-page', 'PageController@edit');
    Route::post('save-page/{id}', 'PageController@savePage');
    Route::get('load-page/{id}', 'PageController@loadPage');
    Route::get('get-block', 'BlockController@getBlock');
    Route::get('get-data-page/{id}','PageController@getDataPage');
});
