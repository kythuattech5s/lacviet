...
Route::group(['prefix' => $admincp, 'middleware' => 'web', 'namespace' => 'vanhenry\manager\controller'], function () {
    ...
    Route::get('/manage-book-apointments', array('uses' => "ManageBookApointmentController@manageBookApointment"));
    Route::post('/manage-book-apointments/action/{type}', array('uses' => "ManageBookApointmentController@manageBookApointmentAction"));
