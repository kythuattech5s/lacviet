...
<div class="comment-box__filter">
    <div class="d-flex comment-box__filter-header justify-content-between align-items-center flex-wrap">
    ...
    <div class="d-flex align-items-center comment-box__filter-content flex-wrap">
