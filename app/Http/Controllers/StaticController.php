...
class StaticController extends Controller
{
    ...
    public function bookApointment($request, $route, $link)
    {
        ...
        $service_text = $request->input('service_text');
        $type = $request->input('type');
        unset($data['service_id']);
        $data['service_text'] = $service_text;
        $data['type'] = $type;
        $sendForm = Support::sentFormGoogleSheet($data, $data['type']);
    ...
    public function resgisterAdvise($request, $route, $link)
    {
        ...
        $sendForm = Support::sentFormGoogleSheet($data, $title);
