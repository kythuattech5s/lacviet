...
class DentalKnowledge extends BaseModel
{
	protected $table = 'dental_knowledges';
    ...
    {
    	return $this->belongsToMany('App\Models\DentalKnowledgeTag', 'dental_knowledge_map_tag', 'dental_knowledge_id', 'dental_knowledge_tag_id')->act()->ord();
    }
    public function pivot(){
    	return $this->hasMany('\App\Models\DentalKnowledgeMapCategory', 'dental_knowledge_id', 'id');
    }
    
    public function category()
    {
    	return $this->belongsToMany('App\Models\DentalKnowledgeCategory','dental_knowledge_map_category','dental_knowledge_id','dental_knowledge_category_id');
    }
    ...
    {
        return $this->hasMany(Rating::class, 'map_id', 'id')->where('map_table', 'dental_knowledges');
    }
    public function comments(){
        return $this->hasMany(Comment::class,'map_id','id')->where('map_table','dental_knowledges')->whereNull('comment_id');
    }
